    ...
    const mailOptions = {
      ...
      html: `
        ...
        <body>
          <div class="container">
            <div class="header">
              <h1>≡ƒÄë Welcome to Alumni Connect!</h1>
            </div>
            <div class="content">
              <h2>Hi ${userName},</h2>
              ...
              <div class="feature">
                <strong>≡ƒô¥ Create Posts:</strong> Share your experiences, achievements, and insights with the community.
              </div>

              <div class="feature">
                <strong>≡ƒñ¥ Connect with ${role === 'student' ? 'Alumni' : 'Students'}:</strong> Network with peers, ${role === 'student' ? 'alumni' : 'current students'}, and expand your professional circle.
              </div>

              <div class="feature">
                <strong>≡ƒÆ╝ Explore Opportunities:</strong> Find jobs, internships, and career guidance from experienced professionals.
              </div>

              <div class="feature">
                <strong>≡ƒôà Attend Events:</strong> Join alumni meetups, webinars, and networking events.
              </div>
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              ...
              <div class="warning">
                <strong>ΓÜá∩╕Å Important:</strong> This link will expire in 1 hour. If you didn't request a password reset, please ignore this email or contact support if you have concerns.
              </div>
